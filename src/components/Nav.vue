...
<template>
    <nav class="navbar navbar-expand-lg bg-success" style="margin-top: -25rem; width: 100%; height: 80px;">
        <div class="container-fluid" style="">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0" v-if="authStore.user">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0" v-if="authStore.user">
                    <li class="nav-item px-lg-5">
                        <button @click="authStore.logout" class="btn btn-danger">Salir</button>
                    </li>
                </ul>
            </div>
        </div>
